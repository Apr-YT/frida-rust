...
| 函数 | 说明 |
|---|---|
| ind_module_base(name) | 获取模块基址 |
| ead_memory(addr, size) | 读取内存 |
...
| Linux AArch64 | arch64-unknown-linux-gnu | arch64-linux-gnu-gcc |
| Android AArch64 | arch64-linux-android | NDK clang |
